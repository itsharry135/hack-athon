<div style="border: 1px solid #ccc; padding: 1rem; border-radius: 5px;">
    ...
    <div style="margin-top: 2rem;">
        ...
        if (isset($_POST["submit_address"])) {
            ...
            $geocode_url = "https://maps.googleapis.com/maps/api/geocode/json?address=" . urlencode($address);
            $geocode_json_data = file_get_contents($geocode_url);
            $geocode_data = json_decode($geocode_json_data);
            ...
            <?php
                ...
                ?>
                <h3 style="margin-bottom: 1rem;">Unable to find address:</h3>
            <?php
            }
