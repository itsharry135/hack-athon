<div style="display: flex; justify-content: space-around;">
    <div>
        <h2 style="margin-bottom: 1rem;">Find address</h2>
        <form method="POST" style="border: 1px solid #ccc; padding: 1rem; border-radius: 5px;">
            <p>
    ...
    <div>
        <h2 style="margin-bottom: 1rem;">Find coordinates</h2>
        <form method="POST" style="border: 1px solid #ccc; padding: 1rem; border-radius: 5px;">
            <p>
